...
description: Update the title and body of an existing pull request WITHOUT asking for approval
---
...
6. **Update** - Execute immediately, without asking for approval (the `/pr-update-now` invocation is the explicit permission). Pass the body via a HEREDOC to preserve formatting:
   ```bash
